...
const lambdaRule_1 = require("../../src/modernization/versions/java8/lambdaRule");
describe('LambdaRule', () => {
    let lambdaRule;
    beforeEach(() => {
        lambdaRule = new lambdaRule_1.LambdaRule();
    });
    describe('Metadata', () => {
...
public class Test {
    public void testMethod() {
        ...
        ActionListener listener = new ActionListener() {
            ...
            const comparatorRange = ranges.find(range => document.getText(range).includes('Comparator<String>'));
            const runnableRange = ranges.find(range => document.getText(range).includes('Runnable'));
...
//# sourceMappingURL=lambdaRule.test.js.map